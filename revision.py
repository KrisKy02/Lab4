...
from proceso import muestra, proceso, grafica2d, grafica3d, distribucion
from proceso import autocorrelacion, autocovarianza
from proceso import prom_temporal, ergodicidad, wss
import pandas as pd
...
# Extrae y muestra un subconjunto de
# datos para un contaminante y sensor específicos
...
print("Fechas para las que se han extraído funciones muestra:",
      list(proceso_ejemplo.keys()))
...
# Convierte la columna de fecha/hora al
# formato datetime y la establece como índice
...
# Calcula y muestra la media temporal
# del contaminante en un intervalo específico
